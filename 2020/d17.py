...
input_grid = [list(x) for x in test.splitlines()]
            ...
            for x in range(1, n):
                for z in range(1, n):
                    if mode == "first":
                        ...
                        if grid[y][x][z] == 1 and 2 <= active <= 3 or grid[y][x][z] == 0 and active == 3:
                            new_grid[y][x][z] = 1
                            active_count += 1
                        else:
                            new_grid[y][x][z] = 0
                        ...
                        for w in range(1, n):
                            ...
                            if grid[y][x][z][w] == 1 and 2 <= active <= 3 or grid[y][x][z][w] == 0 and active == 3:
                                new_grid[y][x][z][w] = 1
                                active_count += 1
                            else:
                                new_grid[y][x][z][w] = 0
